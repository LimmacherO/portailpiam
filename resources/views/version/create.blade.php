...
@section('tabs')
    ...
    <div>
        <ul class="nav nav-tabs" role="tablist">
            <li class="active"><a href="#" aria-controls="home" role="tab"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>&nbsp;&nbsp;Ajout d'une version</a></li>
        </ul>
    </div>
            ...
            <div class="col-lg-12">
                <div class="row section-default-page">
                    ...
                    <div class="col-lg-4 form-group {!! $errors->has('date_mep') ? 'has-error' : '' !!}">
                        ...
                        {!! Form::date('date_mep', \Carbon\Carbon::now(),  ['class' => 'form-control', 'id' => 'date_mep'] ); !!}
