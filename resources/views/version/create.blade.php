...
@section('tabs')
    ...
    <div>
        <ul class="nav nav-tabs" role="tablist">
            <li class="active"><a href="#" aria-controls="home" role="tab"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>&nbsp;&nbsp;Ajout d'un chantier</a></li>
        </ul>
    </div>
        ...
        <div class="row tab-pane active">
            <div class="col-lg-12">
                ...
                <div class="row section-default-page">
                    ...
                    <!--Date de MEP fictive-->
                    {!! Form::hidden('date_mep', \Carbon\Carbon::now(),  ['class' => 'form-control', 'id' => 'date_mep'] ); !!}
